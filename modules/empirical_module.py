...
def retr_timeseries(obs,mm,retr_rad,retr_dis,pstartindex,pstopindex,DSDmidtimes,axparamdict1,image_dir,dis_name,name):
    ...
    ax1.text(0.05,0.79,'Dis Retr. Corr Coeff =%2.3f'%cc_dis.iloc[0,1],transform=ax1.transAxes)
    ax1.text(0.05,0.72,'Rad Retr. Corr Coeff =%2.3f'%cc_rad.iloc[0,1],transform=ax1.transAxes)
