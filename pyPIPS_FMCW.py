...
path = '/Volumes/depot/dawson29/data/VORTEXSE/obsdata/2017/PIPS/PIPS2A_FMCW/'
for root, dirs, files in os.walk(path):
	for f in files:
		if f.endswith("032717.txt"):
			print root
			print f 
			...
			image_dir = '/Users/bozell/VORTEXSE/FMCW/'+radar_date+'/'
