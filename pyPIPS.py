...
#             plotx_wind_1min = date2num(winddates_1min)
    ...
    if(pc.plot_conv_meteo):    
        ...
        axparamdict1 = {'majorxlocator':pc.locator,'majorxformatter':pc.formatter,
                        'minorxlocator':pc.minorlocator,'axeslimits':[[plotstarttime,plotstoptime],[0.0,30.0]],
        ...
        axparamdict1 = {'majorxlocator':pc.locator,'majorxformatter':pc.formatter,
                        'minorxlocator':pc.minorlocator,'axeslimits':[[plotstarttime,plotstoptime],[15.,40.0]],
        ...
        pmin = pressures[startindex:stopindex+1:plotinterval].min()
        pmax = pressures[startindex:stopindex+1:plotinterval].max()
        pmean = pressures[startindex:stopindex+1:plotinterval].mean()
        ...
        axparamdict1 = {'majorxlocator':pc.locator,'majorxformatter':pc.formatter,
                        'minorxlocator':pc.minorlocator,'axeslimits':[[plotstarttime,plotstoptime],[pmin-2.5,pmax+2.5]],
...
#            dBZ_ray_dis_avg = pd.Series(refl_disd).rolling(window=window,center=True,win_type='triang',min_periods=1).mean().values # use for raw distribution
    ...
    ###     Interpolate radar values to match disdrometer times before starting retrieval    
        ...
        em.dis_retr_timeseries(dBZ_rad,dBZ_rad,dBZ,pstartindex,pstopindex,DSDmidtimes,axparamdict1,image_dir,dis_name,name)
        ...
        em.dis_retr_timeseries(ZDR_rad,ZDR_rad,ZDR,pstartindex,pstopindex,DSDmidtimes,axparamdict1,image_dir,dis_name,name)
