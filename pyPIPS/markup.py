...
class page:
    ...
    def __init__(self, mode='strict_html', case='lower', onetags=None,
                 twotags=None, separator='\n', class_=None):
        ...
        valid_onetags = [
            ...
            "META",
            "PARAM"]
        valid_twotags = ["A", "ABBR", "ACRONYM", "ADDRESS", "B", "BDO", "BIG", "BLOCKQUOTE", "BODY",
                         "BUTTON", "CAPTION", "CITE", "CODE", "COLGROUP", "DD", "DEL", "DFN", "DIV",
                         "DL", "DT", "EM", "FIELDSET", "FORM", "FRAMESET", "H1", "H2", "H3", "H4",
                         "H5", "H6", "HEAD", "HTML", "I", "IFRAME", "INS", "KBD", "LABEL", "LEGEND",
                         "LI", "MAP", "NOFRAMES", "NOSCRIPT", "OBJECT", "OL", "OPTGROUP", "OPTION",
                         "P", "PRE", "Q", "SAMP", "SCRIPT", "SELECT", "SMALL", "SPAN", "STRONG",
...
def _argsdicts(args, mydict):
    """
    A utility generator that pads argument list and dictionary values, will only be called with
    len( args ) = 0, 1.
    """
...
class ClosingError(MarkupError):
    def __init__(self, tag):
        self.message = ("The element '%s' does not accept non-keyword arguments ",
                        "(has no closing tag).") % tag
...
class DeprecationError(MarkupError):
    def __init__(self, tag):
        self.message = ("The element '%s' is deprecated, instantiate markup.page with ",
                        "mode='loose_html' to allow it.") % tag
...
class CustomizationError(MarkupError):
    def __init__(self):
        self.message = ("If you customize the allowed elements, you must define both types ",
                        "'onetags' and 'twotags'.")
