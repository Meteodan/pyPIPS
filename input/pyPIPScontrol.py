...
plot_vel_D = False      # Plot terminal-velocity vs. diameter histograms?
vel_range = [0.0, 24.0]
D_range = [0.0, 26.0] 
...
plot_retrieved = False   # Plot meteograms and scattergrams of retrieved variables?
...
locator = dates.MinuteLocator(byminute=[0,15,30,45]) # HourLocator(interval=1)
minorlocator = dates.MinuteLocator(byminute=range(0,60,5)) # MinuteLocator(byminute=[0,15,30,45])
# locator = dates.HourLocator(interval=6)
# minorlocator = dates.HourLocator(interval=1)
