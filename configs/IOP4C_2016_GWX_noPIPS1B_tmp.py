...
PIPS_IO_dict = {
    ...
    'deployment_names': ['IOP4C_D1_2016'] * 2,
    ...
    'PIPS_filenames': ['PIPS2A_2016_IOP4C_D1.txt', 'PIPS2B_2016_IOP4C_D1.txt'],
    'PIPS_filenames_nc': ['parsivel_combined_IOP4C_D1_2016_PIPS2A_60s.nc',
                          'parsivel_combined_IOP4C_D1_2016_PIPS2B_60s.nc'],
    'start_times': ['20160430193000'] * 2,
    'end_times': ['20160430224500'] * 2,
