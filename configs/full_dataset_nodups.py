...
PIPS_file_path_list = glob(PIPS_IO_dict['PIPS_dir'] + '/PIPS*txt')
# Remove files with duplicate data
# PIPS_file_path_list.remove(PIPS_IO_dict['PIPS_dir'] + '/PIPS2A_2017_IOP4C_D1.txt')
PIPS_file_path_list.remove(PIPS_IO_dict['PIPS_dir'] + '/PIPS1A_2016_IOP_4A_D1.txt')
PIPS_file_path_list.remove(PIPS_IO_dict['PIPS_dir'] + '/PIPS1A_2016_IOP_4B_D1.txt')
PIPS_file_path_list.remove(PIPS_IO_dict['PIPS_dir'] + '/PIPS1A_2016_IOP_4C_D1.txt')
