...
PIPS_plotting_dict = {
    ...
    'majorxformatter': dates.DateFormatter('%M:%S'),
    'majorxlocator': dates.MinuteLocator(byminute=range(0, 60, 1)),
    'minorxlocator': dates.SecondLocator(bysecond=range(0, 60, 10)),
    'xlabel': 'Time (HH:MM)'
}
