...
PIPS_IO_dict = {
    'dataset_name': 'IOP1B_D2_2017',
    'deployment_names': ['IOP1B_D2_2017'] * 3,
    ...
    'PIPS_filenames': ['PIPS1A_2017_IOP1B_D2.txt',
                       'PIPS1B_2017_IOP1B_D2.txt', 'PIPS2B_2017_IOP1B_D2.txt'],
    'PIPS_filenames_nc': ['parsivel_combined_IOP1B_D2_2017_PIPS1A_60s.nc',
                          'parsivel_combined_IOP1B_D2_2017_PIPS1B_60s.nc',
                          'parsivel_combined_IOP1B_D2_2017_PIPS2B_60s.nc'],
    'start_times': ['20170328000000'] * 3,
    'end_times': ['20170328040000'] * 3,
...
radar_config_dict = {
    ...
    'el_req': 0.5,
    'radar_start_timestamp': '20170328000000',
    'radar_end_timestamp': '20170328040000',
