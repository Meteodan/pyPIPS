...
RLT: Added a blue-red colormap that I prefer, and set it as the default for velocity 
data.
...
DEFAULT_FIELD_COLORMAP = {
    ...
    velocity: 'BlueRed1',
    corrected_velocity: 'BlueRed1',
    simulated_velocity: 'BlueRed1',
    eastward_wind_component: 'BlueRed1',
    northward_wind_component: 'BlueRed1',
    vertical_wind_component: 'BlueRed1',
...
# RLT: Added a blue-to-red colormap that I prefer to use for velocity data, with a 
# Really tight zero isodop.
...
plt.register_cmap(cmap=BlueRed1)