...
PIPS_file_path_list.remove(PIPS_IO_dict['PIPS_dir'] + '/parsivel_combined_IOP4A_D1_2016_PIPS1A_60s.nc')
PIPS_file_path_list.remove(PIPS_IO_dict['PIPS_dir'] + '/parsivel_combined_IOP4B_D1_2016_PIPS1A_60s.nc')
PIPS_file_path_list.remove(PIPS_IO_dict['PIPS_dir'] + '/parsivel_combined_IOP4C_D1_2016_PIPS1A_60s.nc')
