...
PIPS_IO_dict = {
    ...
    'input_txt_dir': '/Users/dawson29/Dropbox/PIPS_data/2023/incoming/PIPS1B/',
    'PIPS_dir': '/Users/dawson29/Dropbox/PIPS_data/2023/incoming/PIPS1B/netcdf',
    'plot_dir': '/Users/dawson29/Dropbox/PIPS_data/2023/incoming/PIPS1B/plots/10s',
    'PIPS_types': ['PIPS'] * 1,
    'PIPS_names': ['PIPS1B'],
    'PIPS_filenames': ['PIPS1B_IOP2_030323_merged.txt'],
    'PIPS_filenames_nc': ['parsivel_combined_IOP2_030323_PIPS1B_10s.nc'],
    'conv_filenames_nc': ['conventional_raw_IOP2_030323_PIPS1B.nc'],
    'start_times': ['20230303084200'] * 1,
    'end_times': ['20230303111600'] * 1,
