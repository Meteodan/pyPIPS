...
PIPS_IO_dict = {
    ...
    'input_txt_dir': '/Users/dawson29/Dropbox/PIPS_data/2023/incoming/PIPS3B/',
    'PIPS_dir': '/Users/dawson29/Dropbox/PIPS_data/2023/incoming/PIPS3B/netcdf',
    'plot_dir': '/Users/dawson29/Dropbox/PIPS_data/2023/incoming/PIPS3B/plots/10s',
    'PIPS_types': ['PIPS'] * 1,
    'PIPS_names': ['PIPS3B'],
    'PIPS_filenames': ['PIPS3B_IOP2_030323_merged.txt'],
    'PIPS_filenames_nc': ['parsivel_combined_IOP2_030323_PIPS3B_10s.nc'],
    'conv_filenames_nc': ['conventional_raw_IOP2_030323_PIPS3B.nc'],
    'start_times': ['20230303081000'] * 1,
    'end_times': ['20230303113900'] * 1,
