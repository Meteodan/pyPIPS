...
PIPS_IO_dict = {
    ...
    'input_txt_dir': '/Users/dawson29/Dropbox/PIPS_data/2023/incoming/PIPS3A/',
    'PIPS_dir': '/Users/dawson29/Dropbox/PIPS_data/2023/incoming/PIPS3A/netcdf',
    'plot_dir': '/Users/dawson29/Dropbox/PIPS_data/2023/incoming/PIPS3A/plots/10s',
    'PIPS_types': ['PIPS'] * 1,
    'PIPS_names': ['PIPS3A'],
    'PIPS_filenames': ['PIPS3A_IOP2_030323_merged.txt'],
    'PIPS_filenames_nc': ['parsivel_combined_IOP2_030323_PIPS3A_10s.nc'],
    'conv_filenames_nc': ['conventional_raw_IOP2_030323_PIPS3A.nc'],
    'start_times': ['20230303081000'] * 1,
    'end_times': ['20230303114000'] * 1,
