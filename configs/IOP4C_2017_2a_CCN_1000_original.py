...
PIPS_IO_dict = {
    ...
    'plot_dir': '/depot/dawson29/data/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/PIPS/New/plots/full_time/CCN1000_original/',
    'PIPS_types': ['PIPS'] * 1,
    'PIPS_names': ['PIPS2A'],
...
model_config_dict = {
    ...
    'model_dt_mean': 300.,
    'cycle': 'prior',
    'basedirname': '/scratch/rice/c/cbelak/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/1km243x243_3km153x153_043017_New/',
