...
PIPS_IO_dict = {
    ...
    'PIPS_dir': '/scratch/rice/c/cbelak/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/Test/',
    'plot_dir': '/depot/dawson29/data/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/PIPS/New/plots/plot_vel_D/vel_D/',
    'PIPS_types': ['PIPS'] * 1,
    'PIPS_names': ['PIPS2A'],
