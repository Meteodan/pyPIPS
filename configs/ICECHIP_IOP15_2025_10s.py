"""Configuration script for ICECHIP 2025 IOP15 deployment"""
...
PIPS_IO_dict = {
    ...
    'PIPS_filenames': ['PIPS1A_IOP15_061225_merged.txt', 'PIPS1B_IOP15_061225_merged.txt',
                       'PIPS2A_IOP15_061225_merged.txt', 'PIPS2B_IOP15_061225_merged.txt',
                       'PIPS3A_IOP15_061225_merged.txt', 'PIPS3B_IOP15_061225_merged.txt'],
    'PIPS_filenames_nc': ['parsivel_combined_IOP15_061225_PIPS1A_10s.nc',
                          'parsivel_combined_IOP15_061225_PIPS1B_10s.nc',
                          'parsivel_combined_IOP15_061225_PIPS2A_10s.nc',
                          'parsivel_combined_IOP15_061225_PIPS2B_10s.nc',
                          'parsivel_combined_IOP15_061225_PIPS3A_10s.nc',
                          'parsivel_combined_IOP15_061225_PIPS3B_10s.nc'],
    'conv_filenames_nc': ['conventional_raw_IOP15_061225_PIPS1A.nc',
                          'conventional_raw_IOP15_061225_PIPS1B.nc',
                          'conventional_raw_IOP15_061225_PIPS2A.nc',
                          'conventional_raw_IOP15_061225_PIPS2B.nc',
                          'conventional_raw_IOP15_061225_PIPS3A.nc',
                          'conventional_raw_IOP15_061225_PIPS3B.nc'],
    'start_times': ['20250612215000'] * 6,
    'end_times': ['20250613000700'] * 6,
