"""Configuration script for PERiLS 2022 IOP2 deployment (PIPS3B only)"""
...
PIPS_IO_dict = {
    ...
    'PIPS_types': ['PIPS'],
    'PIPS_names': ['PIPS3B'],
    'PIPS_filenames': ['PIPS3B_IOP2_033022_merged.txt'],
    'PIPS_filenames_nc': ['parsivel_combined_IOP2_033022_PIPS3B_10s.nc'],
    'conv_filenames_nc': ['conventional_raw_IOP2_033022_PIPS3B.nc'],
    'start_times': [None],
    'end_times': [None],
