...
PIPS_IO_dict = {
    ...
    'plot_dir': '/depot/dawson29/data/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/PIPS/plots',
    'PIPS_types': ['PIPS'] * 1,
    'PIPS_names': ['PIPS2A'],
    'PIPS_filenames': ['PIPS2A_FMCW_043017.txt'],
    'PIPS_filenames_nc': ['parsivel_combined_IOP4C_D1_2017_PIPS2A_60s.nc'],
    'start_times': [None] * 1,
    'end_times': [None] * 1,
...
model_config_dict = {
    ...
    'model_dt': 60.,
    'model_dt_mean': 900.,
    'basedirname': '/depot/dawson29//data/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/1km243x243_3km153x153_043017',
    'timestamp_model_init': '20170430060000',
    'timestamp_model_start': '20170430203000',
    'timestamp_model_stop': '20170430213000',
    'nproc_x': 3,
    'nproc_y': 5,
}
